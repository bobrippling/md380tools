...
flash_original_D13: original_D13
	python3 ./md380-dfu upgrade firmware/bin/D013.020.bin

flash_original_D13.34: original_D13.34
	python3 ./md380-dfu upgrade firmware/bin/D013.034.bin

flash_original_S13: original_S13
	python3 ./md380-dfu upgrade firmware/bin/S013.020.bin

flash_original_D02: original_D02
	python3 ./md380-dfu upgrade firmware/bin/D002.032.bin

flash_original_D03: original_D03
	python3 ./md380-dfu upgrade firmware/bin/D003.020.bin

flash: image_D13
	python3 ./md380-dfu upgrade applet/experiment.bin
settime:
	python3 ./md380-dfu settime
flash_D02: image_D02
	python3 ./md380-dfu upgrade applet/experiment.bin
